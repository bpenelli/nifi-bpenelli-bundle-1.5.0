...
public class HBaseMapCacheClientService extends AbstractControllerService implements HBaseMapCacheClient {
    ...
    public <K, V> boolean checkAndPut(final K key, final V value, final V checkValue, final Serializer<K> keySerializer, final Serializer<V> valueSerializer) throws IOException {
        ...
        return hBaseClientService.checkAndPut(hBaseCacheTableName, rowIdBytes, hBaseColumnFamilyBytes, hBaseColumnQualifierBytes, checkBytes, putColumn);
    }
    ...
    public <K, V> V get(final K key, final Serializer<K> keySerializer, final Deserializer<V> valueDeserializer) throws IOException {
      ...
      final List<Column> columnsList = new ArrayList<Column>(0);
      Column col = new Column(hBaseColumnFamilyBytes, hBaseColumnQualifierBytes);
      columnsList.add(col);
